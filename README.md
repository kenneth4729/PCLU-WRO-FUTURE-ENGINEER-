...
<h3>Our self driving car uses an Rack and pinion steering system which provides precise and stable controls for moving and turning. It’s a system that makes your car respond to every turn with precision, giving you the control you need to navigate the road safely. This system is use so our vehicle can turn on the corners smoothly and adjust itself back to the center of the track, with this kind of system our robot can turn on the tight corners a lot easier. </h3>
<br><br><br><br><br>
